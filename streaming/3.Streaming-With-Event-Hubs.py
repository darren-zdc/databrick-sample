...
# MAGIC 
# MAGIC val connectionString = "Endpoint=sb://databrickseventhubs2.servicebus.windows.net/;SharedAccessKeyName=RootManageSharedAccessKey;SharedAccessKey=5GFh3w0RT5ySJQpBpB54OiCA5zBSQDGVosZihiyTb68="
# MAGIC 
